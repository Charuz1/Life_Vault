...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute top-[10%] left-[10%] w-[500px] h-[500px] bg-primary/40 rounded-full mix-blend-screen blur-[120px] animate-blob" />
      <div className="absolute bottom-[10%] right-[10%] w-[500px] h-[500px] bg-secondary/40 rounded-full mix-blend-screen blur-[120px] animate-blob animation-delay-2000" />
      ...
      <div className="w-full max-w-md glass border border-white/10 rounded-3xl p-10 relative z-10 shadow-2xl">
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-muted-foreground mt-3 text-center text-lg">Enter your credentials to access your vault</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              ...
              <a href="#" className="text-sm text-primary hover:text-white transition-colors font-medium">Forgot password?</a>
            </div>
            <div className="relative group">
        ...
        <p className="text-center text-muted-foreground mt-8 text-lg">
          Don't have an account? <Link to="/register" className="text-primary font-bold hover:text-white transition-colors">Create Account</Link>
        </p>
      </div>
    </div>
  );
